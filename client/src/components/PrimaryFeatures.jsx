...
export function PrimaryFeatures() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-iowaYellow-600 pb-28 pt-20 sm:py-32"
    >
      <Image
                    ...
                    >
                      <h3>
                        <Tab
                          className={clsx(
                            ...
                            selectedIndex === featureIndex
                              ? 'text-iowaYellow-600 lg:text-white'
                              : 'text-iowaYellow-100 hover:text-white lg:text-white',
                          )}
                        >
                      ...
                      <p
                        className={clsx(
                          ...
                          selectedIndex === featureIndex
                            ? 'text-white'
                            : 'text-iowaYellow-100 group-hover:text-white',
                        )}
                      >
                        {feature.description}
                      </p>
              ...
              <Tab.Panels className="lg:col-span-7">
                {features.map((feature) => (
                  <Tab.Panel key={feature.title} unmount={false}>
                    ...
                    <div className="mt-10 w-[45rem] overflow-hidden rounded-xl bg-slate-50 shadow-xl shadow-iowaYellow-900/20 sm:w-auto lg:mt-0 lg:w-[67.8125rem]">
                      <Image
                        className="w-full"
                        src={feature.image}
                        alt="fdas"
